...
#### Apply 3_0_fix.patch
- Мелкие правки и небольшой рефакторинг
- В `User` делаю копию `roles`, чтобы роли нельзя было изменить после инициализации, использую `EnumSet`
...
> Внимание- патч обновился 17.02 в 14.40 (добавил `guest` в данные). Вместе с ним обновился патч `3_13_test_UserService`
